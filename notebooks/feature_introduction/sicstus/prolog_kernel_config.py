...
# The following shows the usage of the relative path to the Logtalk server code
c.LogtalkKernel.backend_data = {
   "swi": {
       "failure_response": "false",
       "success_response": "true",
   ...
   "sicstus": {
       ...
       "program_arguments": ["sicstus",
                             "-l", "../../../logtalk_kernel/prolog_server/jupyter_server.pl",
